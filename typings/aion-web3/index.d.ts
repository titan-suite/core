declare module 'aion-web3' {
  ...
  class Web3 {
    ...
    public personal: Web3.PersonalApi
  ...
  namespace Web3 {
    ...
    interface EthApi {
      personal: Web3.PersonalApi // temp
      coinbase: string
      mining: boolean
      hashrate: number
      ...
      compileSolidity(contract: string): any // temp
    ...
    interface PersonalApi {
      ...
      sign(hexMessage: string, account: string): Promise<string>
    }
