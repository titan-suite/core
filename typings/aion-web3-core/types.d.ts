...
type Unit = "nAmp"|"uAmp"|"mAmp"|"Amp"|"uAION"|"mAION"|"cAION"|"dAION"|"AION"
...
export declare interface Utils {
    ...
    fromNAmp(val: string | number | BigNumber, unit: Unit): string | BigNumber
